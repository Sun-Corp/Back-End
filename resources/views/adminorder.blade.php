        ...
        <div class="sidebar">
          ...
          <div class="sidebar-body">
            <ul class="nav nav-list">
              <li class="nav-item">
                <a href="/admin" class="nav-link text-light text-center navigation-link">kelola</a>
              </li>
              ...
              <tbody>
                ...
                @php
                    foreach ($Acaras as $acara) {
                      if ($order->AcaraID == $acara->AcaraID){
                        $NamaTemplate = $acara->NamaTemplate;
                        $NamaTema = $acara->NamaTema;
                      }
                    }
                @endphp
                <tr>
                  ...
                  <td>{{$NamaTema}}</td>
                  <td>
                    <a href="/updateorder/{{'InvoiceStatus'}}/{{$order->OrderID}}">
                  ...
                  <td>
                    <a href="/updateorder/{{'VerifikasiStatus'}}/{{$order->OrderID}}">
                      @if ($order->VerifikasiStatus)
                  ...
                  <td>
                    <a href="/updateorder/{{'OrderStatus'}}/{{$order->OrderID}}">
