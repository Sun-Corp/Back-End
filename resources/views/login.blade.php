    ...
    <body class="antialiased">
        @if(Session::has('alert'))
            <div class="alert alert-danger">
                {{Session::get('alert')}}
                <button id='close' type='button' data-dismiss='alert' aria-label='Close' onclick="this.parentElement.style.display='none';">
                    x
                </button>
            </div>
        @endif
        ...
        <div class="container justify-content-center">
            <div class="card">
                <span class="card-title">Get your dream weeding website</span>
